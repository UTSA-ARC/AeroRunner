...
int AFS_SEL, GFS_SEL, ALSB_Sensitivity, GLSB_Sensitivity;
...
void loop() {
  ...
  Serial.println(RawAccX / ALSB_Sensitivity + c + RawAccY / ALSB_Sensitivity + c + RawAccZ / ALSB_Sensitivity); // Arduino is really dumb again
  ...
  Serial.println(RawGyroX / GLSB_Sensitivity + c + RawGyroY / GLSB_Sensitivity + c + RawGyroZ / GLSB_Sensitivity); // Arduino is really dumb again,...again, and again
