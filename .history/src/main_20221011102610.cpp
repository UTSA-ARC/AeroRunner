...
std::vector<fixed> Accel(fixed raw_x, fixed raw_y, fixed raw_z) {
  ...
  std::vector<fixed> normalized_accel = {raw_x / ALSB_Sensitivity, raw_y / ALSB_Sensitivity, raw_z / ALSB_Sensitivity};
...
std::vector<fixed> Accel(std::vector<fixed> raw_accel) {
  ...
  std::vector<fixed> normalized_accel = {raw_accel.at(0) / ALSB_Sensitivity, raw_accel.at(1) / ALSB_Sensitivity, raw_accel.at(2) / ALSB_Sensitivity};
  return normalized_accel;
