...
std::vector<fixed> Get_Raw_Accel() {
...
std::vector<fixed> Accel(fixed raw_x, fixed raw_y, fixed raw_z) {
  
  std::vector<fixed> normalized_accel = {
...
std::vector<fixed> Accel(std::vector<fixed> raw_accel) {
...
void loop() {
  ...
  std::vector<fixed> accel = Accel(Get_Raw_Accel());
