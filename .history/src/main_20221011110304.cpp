...
Vector<int> Normalized_Accel(Vector<int> raw_accel) {
  ...
  normalzied_accel.push_backraw_accel.at(0) / ALSB_Sensitivity, 
  normalzied_accel.push_backraw_accel.at(1) / ALSB_Sensitivity, 
  normalzied_accel.push_backraw_accel.at(2) / ALSB_Sensitivity
