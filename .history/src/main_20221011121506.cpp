...
Vector<int> Normalized_Gyro(Vector<int> raw_gyro) {
  ...
  normalized_gyro.push_back(raw_gyro.at() / GLSB_Sensitivity);
  normalized_gyro.push_back(RawGyroY / GLSB_Sensitivity);
  normalized_gyro.push_back(RawGyroZ / GLSB_Sensitivity);
